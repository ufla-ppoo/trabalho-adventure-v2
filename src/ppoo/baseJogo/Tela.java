...
public class Tela implements InterfaceUsuario
{
    ...
    public Tela(String nomeJogo) {        
        ...
        // criando o painel central que mostra a imagem do ambiente e os itens que o jogador coletou
        criarPainelCentral();
    ...
    /**
     * Cria o painel central que mostra a imagem do ambiente e os itens que o jogador pegou
     */
    ...
    /**
     * Limpa as mensagens exibidas para o jogador (não precisa ser usada no terminal)
     */
    @Override
